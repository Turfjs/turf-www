...
| ----------------- | ----------------------------------------------------------------------------------------------- | ---------------------------- |
| fc                | **[FeatureCollection](https://tools.ietf.org/html/rfc7946#section-3.3)\<T\>**                   |                              |
| num               | **[number](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Number)** | number of features to select |
