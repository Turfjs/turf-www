...
any [Feature](https://tools.ietf.org/html/rfc7946#section-3.2) in \{@link FeatureCollection\<Polygon> \| obstacles}
...
| options.minDistance<i>?</i> | **number**                                                                                                                                                                                                                                                           | minimum distance between shortest path and obstacles                                                                                          |
