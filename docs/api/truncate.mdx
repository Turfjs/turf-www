...
| options.precision<i>?</i>   | **[number](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Number)**   | coordinate decimal precision _(default 6)_                                                      |
| options.coordinates<i>?</i> | **[number](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Number)**   | maximum number of coordinates (primarly used to remove z coordinates) _(default 3)_             |
...
function Map() {
  ...
  return <ExampleMap addToMap={{ truncated }} />;
}
```
