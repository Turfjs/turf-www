...
| options.units<i>?</i> | **[Units](docs/api/types/Units.mdx)**                                                                                                      | the units of the numeric result. Supports all valid Turf [Units](https://turfjs.org/docs/api/types/Units). _(default 'kilometers')_ |
