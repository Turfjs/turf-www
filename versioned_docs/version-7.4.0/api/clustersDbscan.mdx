...
| options.units<i>?</i>     | **[Units](docs/api/types/Units.mdx)**                                                                                                      | in which `maxDistance` is expressed, Supports all valid Turf [Units](https://turfjs.org/docs/api/types/Units) _(default "kilometers")_                     |
