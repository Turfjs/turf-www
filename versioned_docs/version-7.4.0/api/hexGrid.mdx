...
| options.units<i>?</i>      | **[Units](docs/api/types/Units.mdx)**                                                                                                                                                                       | used in calculating cell size. Supports all valid Turf [Units](https://turfjs.org/docs/api/types/Units). _(default 'kilometers')_         |
