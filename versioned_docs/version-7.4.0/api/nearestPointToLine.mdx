...
| options.units<i>?</i>      | **[Units](docs/api/types/Units.mdx)**                                                                                                                                                                                     | unit of the output distance property. Supports all valid Turf [Units](https://turfjs.org/docs/api/types/Units). (eg: degrees, radians, miles, or kilometers) _(default 'kilometers')_ |
