...
| options.units<i>?</i>      | **[Units](docs/api/types/Units.mdx)**                                                                                                                                                                                                                                                                                                                  | unit in which resolution & minimum distance will be expressed in; Supports all valid Turf [Units](https://turfjs.org/docs/api/types/Units). _(default 'kilometers')_ |
