...
| options.ignoreSelfIntersections<i>?</i> | **[boolean](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Boolean)** | ignores self-intersections on input features _(default true)_ |
