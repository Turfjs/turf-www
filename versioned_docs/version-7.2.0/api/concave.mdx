...
| options.maxEdge<i>?</i> | **[number](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Number)**                                        | the length (in 'units') of an edge necessary for part of the hull to become concave. _(default Infinity)_ |
